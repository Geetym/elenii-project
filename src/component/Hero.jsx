...
const Hero = () => {
  return (
    <div
      className="flex flex-col-reverse md:flex-row items-center w-full px-6 md:px-12 py-16 min-h-[50vh] md:h-screen bg-gray-100 bg-cover bg-center gap-6 md:gap-12"
